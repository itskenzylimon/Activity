...
class MainController extends ActiveController {
            ...
            "elements": [
              {
                "elements": [
                  ...
                  },
                  {
                    ...
                    "type": "text",
                    "visibleIf": "{MotherFathersName} anyof ['Minor (below 18years)', 'Not Able to Access Identification Document'] or {MotherTypeofNationality} anyof ['Foreigner']"
                  },
                  {
  ...
  reOrganizeData() {
    ...
    for (var i in schema['service']['schema']['pages']) {
      for (var j in i['elements']) {
        if (j['elements'] != null) {
          for (var k in j['elements']) {
            if (k['type'] == 'httplookup') {
              k['lookup'] = [];
              for (var l in schema['lookup_services']) {
